...
const DESKTOP_BG = `
  body {
    background: linear-gradient(135deg, ${C.secondary} 0%, #2a1f6e 40%, ${C.primary} 100%) !important;
    min-height: 100vh;
  }
`;
...
function QuizMode({ xp, setXp, onBack, onGoGame, onGoLearn, onGoHome, onComplete, rewardEnabled = true }) {
  ...
  if (done) return (
    <div style={appSt}>
      <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;600;700;800;900&display=swap" rel="stylesheet" /><style dangerouslySetInnerHTML={{__html: DESKTOP_BG}} />
      <Nav xp={xp} />
...
export default function FinanzasTaller() {
  ...
  const appSt = { fontFamily: "'Plus Jakarta Sans',sans-serif", background: C.bgSoft, minHeight: "100vh", color: C.text, maxWidth: 500, margin: "0 auto", boxShadow: "0 0 60px rgba(0,0,0,.25)" };
  const desktopBg = `
    body {
      background: linear-gradient(135deg, ${C.secondary} 0%, #2a1f6e 40%, ${C.primary} 100%);
      min-height: 100vh;
    }
  `;
  ...
  if (accessStep === "gate") return (
    <div style={appSt}>
      <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;600;700;800;900&display=swap" rel="stylesheet" /><style dangerouslySetInnerHTML={{__html: desktopBg}} /><style dangerouslySetInnerHTML={{__html: DESKTOP_BG}} />
